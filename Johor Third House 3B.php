...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="Johor Third House 3B.css">
    ...
    <body>
        ...
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-6">
                    <img src="Johor Third House Plan View2.jpg" alt="Image Alt Text" class="house-plan-view">
                </div>
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12 form">
                            <form>
                                ...
                                <p class="left-text ps-2">Property Type <br>
                                    <span class="text1">2-Storey Terrace House</span>
                                </p>
                                <p class="right-text">Developer <br>
                                    <span class="text2">Meridin East Sdn Bhd</span>
                                </p>
                                <hr class="line">
                                ...
                                <p class="left-text ps-2">Listing ID <br>
                                    <span class="text1">35567782</span>
                                </p>
                        ...
                        <div class="col-md-12 form">
                            <form>
                                ...
                                <div class="unit-types">
                                    ...
                                    <p class="unit-type">4+1 Bedrooms</p>
                                </div>
                                <hr class="line1">

                                <div class="unit-info-container">
                                    <div class="unit-info-left">
                                        <a class="black-button" href="Johor Third House 3.php">
                                            <p class="unit-info">Type B1 <br> 1670 sqft</p>
                                        </a>
                                        <a class="white-button mt-2" href="Johor Third House 3B.php">
                                            <p class="unit-info">Type B2 <br> 1878 sqft</p>
                                        </a>
                                    </div>
                                    <div class="unit-info-right">
                                        <p class="price-text">RM680,000</p>
                                ...
                                <div class="property-info pt-2">
                                    ...
                                    <p class="property-info-text">1670 sqft - 1878 sqft</p>
        ...
        <footer class="mt-3">
            <div class="row">
              <div class="col-12 text-left" >
                <a href="Johor Third House 3.php" class="go-back-button">Go back</a>
              </div>
            </div>
        </footer>

        <script src="Johor Third House 3B.js"></script>
        <script>
            function buyHouse() {
