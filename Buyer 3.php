...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Buyer 3.css">
        ...
        <div class="row">
            <div class="col-md-3 mb-3">
                <a href="#" class="card-link">
                    <div class="card">
                        <a href="Penang House.php">
                            <img src="Penang House.jpg" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <div class="bed-info">
                                <p class="additional-info">
                                    ...
                                    <span class="dot"> • </span>
                                    <span>1,208 sqft</span>
                                    <span class="dot"> • </span>
                                    <span>RM 370 psf</span>
                            ...
                            <p class="state-of-malaysia py-2">
                                Penang
                                <img src="Penang.png" class="ms-2" alt="Image Description">
                            </p>
                            <div class="row">
            ...
            <div class="col-md-3 mb-3">
                <a href="#" class="card-link">
                    <div class="card">
                        <a href="Penang Second House.php">
                            <img src="Penang House 4.jpg" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body mt-2">
                            <div class="bed-info">
                                <p class="additional-info">
                                    <span class="price">RM840,000</span><br><br>
                                    ...
                                    <span class="dot"> • </span>
                                    <span>RM 538 psf</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-heart love-icon" viewBox="0 0 20 20">
                                        <path d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.920 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15z"></path>
                                    </svg>                                                                      
                                </p>
                            </div>
                            <p class="state-of-malaysia my-3">
                                Penang
                                <img src="Penang.png" class="ms-2" alt="Image Description">
                            </p>
                            <div class="row">
                ...
                <a href="#" class="card-link">
                    <div class="card">
                        <a href="Penang Third House.php">
                            <img src="Penang House 7.jpg" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body mt-2">
                            <div class="bed-info">
                                <p class="additional-info my-3">
                                    <span class="price">RM900,000</span><br><br>
                                    <span class="icon-with-margin">2 <i class="fas fa-bed"></i></span>
                                    <span class="icon-with-margin">2 <i class="fas fa-bath"></i></span>
                                    <span class="dot"> • </span>
                                    <span>1,033 sqft</span>
                                    <span class="dot"> • </span>
                                    <span>RM 368 psf</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-heart love-icon" viewBox="0 0 20 20">
                                        <path d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.920 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15z"></path>
                                    </svg>                                                                      
                                </p>
            ...
            <div class="col-md-3 mb-3">
                <a href="#" class="card-link">
                    <div class="card">
                        <a href="Penang Fourth House.php">
                            <img src="Penang House 10.jpg" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <div class="bed-info">
                                <p class="additional-info my-3">
                                    <span class="price">RM700,800</span><br><br>
                                    <span class="icon-with-margin">4+1 <i class="fas fa-bed"></i></span>
                                    <span class="icon-with-margin">4 <i class="fas fa-bath"></i></span>
                                    <span class="dot"> • </span>
                                    <span>2,727 sqft</span>
                                    <span class="dot"> • </span>
                                    <span>RM 688 psf</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-heart love-icon" viewBox="0 0 20 20">
                                        <path d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.920 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15z"></path>
                                    </svg>                                                                      
                                </p>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            <li class="page-item">
                                <a class="page-link" href="Buyer 2.php" aria-label="Previous">
