...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Penang House 2.css">
...
<body>
                    ...
                    <div class="form-group d-flex align-items-center">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">1,208 sqft</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">RM 370 psf</span>
                            </div>
                        </div>
                    </div>
                    <img src="Penang House.jpg" alt="House Image" class="house-image" id="houseImage">
                </form>
            </div>
            <div class="col-md-6">
                <form>
                    <div class="form-group">
                        ...
                        <h2 class="form-title2 pt-2">Steven Sim</h2>                  
                ...
                <form>
                    <div class="form-group">
                        ...
                        <p class="additional-text3">
                            Freehold condominium with residential title. <br>
                            Complete with 24/7 security. Surrounded by thematic <br>
                            landscapes. Flexible spaces for a vibrant lifestyle. <br><br>
                            Pneumatic automated waste collected system. Obtained <br>
                            BCA Green Mark Certification. 4-acre family-oriented <br>
                            facilities.
                        </p>
                        <a href="Penang House 3.php" class="view-more">View more...</a>
                    </div>
                    <div class="form-group text-right location-container">
                        ...
                        <br>
                        <span class="location">Batu Ferringhi, Penang</span>
                        <a href="PenangFirstHouseMap.php" class="view-on-map">View on Map</a>
                    </div>
                </form>
            </div>
            <div class="col-md-12 d-flex justify-content-center align-items-center">
                <form>
                    <div class="form-group">
                        ...
                        <span class="albert-text ms-2">Christina</span>
                        ...
                        <div class="rating-container ms-3">
                            ...
                            <span class="rating-date">30 September 2023</span><br>
                            <span class="review-text">Got a beautiful view.</span> 
                        </div> 
                    </div>
                </form>
            </div>
    ...
    <script src="Penang House 2.js"></script>
</body>
</html>