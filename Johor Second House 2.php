...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Johor Second House 2.css">
...
<body>
            ...
            <div class="col-md-6">
                <form>
                    <div class="form-group d-flex align-items-center">
                        <div>
                            <h2 class="form-title">RM540,000</h2>
                            <h5 class="additional-text">Est. Repayment RM 2,250 / month</h5>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">1105 sqft</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">RM 338 psf</span>
                            </div>
                        </div>
                    </div>
                    <img src="Johor House 4.jpg" alt="House Image" class="house-image" id="houseImage">
                </form>
            </div>
            <div class="col-md-6">
                <form>
                    <div class="form-group">
                        ...
                        <h2 class="form-title2 pt-2">Sean Raj</h2>                  
                ...
                <form>
                    <div class="form-group">
                        ...
                        <p class="additional-text3">
                            A stone's throw from Legoland Malaysia, Mall of Medini, <br>
                            EduCity Malaysia and Gleneagles medical centre. <br>
                            Open to foreigners to purchase with attractive tax <br>
                            incentives. 10 minutes to Tuas Checkpoint.
                        </p>
                        <a href="Johor Second House 3.php" class="view-more">View more...</a>
                    </div>
                    <div class="form-group text-right location-container">
                        ...
                        <br>
                        <span class="location">Iskandar Puteri, Johor</span>
                        <a href="JohorSecondHouseMap.php" class="view-on-map">View on Map</a>
                    </div>
                </form>
            </div>
            <div class="col-md-12 d-flex justify-content-center align-items-center">
                <form>
                    <div class="form-group">
                        ...
                        <span class="albert-text ms-2">Michelle</span>
                        ...
                        <div class="rating-container ms-3">
                            ...
                            <span class="rating-date">28 October 2023</span><br>
                            <span class="review-text">Wonderful place!</span> 
                        </div> 
                    </div>
                </form>
            </div>
    ...
    <script src="Johor Second House 2.js"></script>
</body>
</html>