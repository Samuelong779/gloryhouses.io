...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Seller 2.css">
            ...
            <div class="col-md-6">
                <form>
                    <div class="form-group d-flex align-items-center">
                        <div>
                            <h2 class="form-title">RM810,000</h2>
                            <h5 class="additional-text">Est. Repayment RM 3,375 / month</h5>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">3,010 sqft</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">RM 269 psf</span>
                            </div>
                        </div>
                    </div>
                    <img src="Seller House 2.jpg" alt="House Image" class="house-image" id="houseImage">
                </form>
            </div>
            <div class="col-md-6">
                <form>
                    <div class="form-group">
                        ...
                        <h2 class="form-title2 pt-2">John Lim</h2>                  
                ...
                <form>
                    <div class="form-group">
                        ...
                        <p class="additional-text3">
                            5 mins to Rawang Bypass<br>
                            Cheapest Hilltop Freehold 2-Storey @ Rawang<br>
                            Nett Salary RM4,300 can Apply,<br>
                            LPPSA Welcome<br>
                            Free Loan Service Consultation<br>
                            Hot selling projects with End / Corner units....
                        </p>
                        <a href="Seller 3.php" class="view-more">View more...</a>
                    </div>
                    <div class="form-group text-right location-container">
                        ...
                        <br>
                        <span class="location">Rawang, Selangor</span>
                        <a href="SelangorFourthHouseMap.php" class="view-on-map">View on Map</a>
                    </div>
                </form>
            </div>
            <div class="col-md-12 d-flex justify-content-center align-items-center">
                <form>
                    <div class="form-group">
                        ...
                        <span class="albert-text ms-2">Albert</span>
                        ...
                        <div class="rating-container ms-3">
                            ...
                            <span class="rating-date">23 September 2023</span><br>
                            <span class="review-text">Good Place.</span> 
                        </div> 
                    </div>
                </form>
            </div>
