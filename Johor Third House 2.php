...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Johor Third House 2.css">
            ...
            <div class="col-md-6">
                <form>
                    <div class="form-group d-flex align-items-center">
                        <div>
                            <h2 class="form-title">RM480,000</h2>
                            <h5 class="additional-text">Est. Repayment RM 2,000 / month</h5>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">1,670 sqft</span>
                            </div>
                        </div>
                    ...
                    <img src="Johor House 7.jpg" alt="House Image" class="house-image" id="houseImage">
                </form>
            </div>
            <div class="col-md-6">
                <form>
                ...
                <form>
                    <div class="form-group">
                        ...
                        <p class="additional-text3">
                            Meridin East epitomizes the ideals of an ultramodern luxury <br>
                            lifestyle, a home full of extraordinary features, awaiting <br>
                            you to interact and explore in its full glory with your <br>
                            five senses. Strategically situated in the Eastern Gateway <br>
                            of Iskandar Malaysia, Meridin East is a 1,313-acre guarded lake <br>
                            garden community blessed with ample outdoor activity spaces. <br>
                            It is connected to key highways with easy access to Johor <br>
                            Bahru City Centre, Singapore and other key landmarks.
                        </p>
                        <a href="Johor Third House 3.php" class="view-more">View more...</a>
                    </div>
                    <div class="form-group text-right location-container">
                        ...
                        <br>
                        <span class="location">Pasir Gudang, Johor</span>
                        <a href="JohorThirdHouseMap.php" class="view-on-map">View on Map</a>
                    </div>
                </form>
            </div>
            <div class="col-md-12 d-flex justify-content-center align-items-center">
                <form>
                    <div class="form-group">
                        ...
                        <span class="albert-text ms-2">Tony</span>
                        ...
                        <div class="rating-container ms-3">
                            ...
                            <span class="rating-date">7 November 2023</span><br>
                            <span class="review-text">The house was save to be stay.</span> 
                        </div> 
                    </div>
                </form>
            </div>
    ...
    <footer class="mt-3">
        <div class="row">
          <div class="col-12 text-left" >
            <a href="Johor Third House.php" class="go-back-button">Go back</a>
          </div>
        </div>
    </footer>

    <script src="Johor Third House 2.js"></script>
</body>
</html>