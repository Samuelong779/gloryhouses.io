...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Penang Fourth House.css">
...
<body>
    ...
    <div class="container pt-2">
        <div class="row">
            <div class="col-6 d-flex align-items-center justify-content-end">
                <img src="Penang House 10.jpg" alt="Left Image" class="left-image" id="leftImage">
            </div>
            <div class="col-6">
                <div class="row">
                    <div class="col-12 py-2 d-flex align-items-center justify-content-center">
                        <img src="Penang House 11.jpg" alt="Top Image" class="right-image" id="topImage">
                    </div>
                    <div class="col-12 pt-3 d-flex align-items-center justify-content-center">
                        <img src="Penang House 12.jpg" alt="Bottom Image" class="right-image" id="bottomImage">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-6 d-flex justify-content-start">
                <span class="property-text">DOUBLE STOREY SUPERLINK HOMES | FREEHOLD - BANDAR SETIA FONTAINES, KEPALA BATAS, PENANG</span>
            </div>
        ...
        <div class="row">
            <div class="col-12 d-flex text-start">
                <a href="Penang Fourth House 2.php" class="view-details-link">View more Details</a>
            </div>
        </div>        
    </div>
    ...
    <script src="Penang Fourth House.js"></script>
</body>
</html>