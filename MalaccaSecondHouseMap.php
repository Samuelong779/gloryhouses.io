...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="MalaccaSecondHouseMap.css">
    ...
    <body>
        ...
        <div class="container pt-3 text-center">
            <div class="row">
                <div class="col">
                    <h1 class="description py-3">Here are the Google Maps view for you house location: </h1>
                    <img src="MalaccaSecondHouseMap.png" class="map" alt="Description of the image">
                </div>
            </div>
        </div>
