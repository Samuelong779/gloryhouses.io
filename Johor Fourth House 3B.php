...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="Johor Fourth House 3B.css">
    ...
    <body>
        ...
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-6">
                    <img src="Johor Fourth House Plan View2.jpg" alt="Image Alt Text" class="house-plan-view">
                </div>
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12 form">
                            <form>
                                ...
                                <p class="right-text">Developer <br>
                                    <span class="text2">M Minori Sdn Bhd</span>
                                </p>
                                <hr class="line">
                                ...
                                <p class="left-text ps-2">Listing ID <br>
                                    <span class="text1">25567538</span>
                                </p>
                        ...
                        <div class="col-md-12 form">
                            <form>
                                ...
                                <div class="unit-types">
                                    <p class="unit-type">1+1 Bedrooms</p>
                                ...
                                <div class="unit-info-container">
                                    <div class="unit-info-left">
                                        <a class="black-button" href="Johor Fourth House 3.php">
                                            <p class="unit-info">Type A <br> 670 sqft</p>
                                        </a>
                                        <a class="white-button mt-2" href="Johor Fourth House 3B.php">
                                            <p class="unit-info">Type B <br> 880 sqft</p>
                                        </a>
                                    </div>
                                    <div class="unit-info-right">
                                        <p class="price-text">RM488,000</p>
                                        <a class="starting-from-button" href="#">Starting From</a>
                                    </div>
                                </div>
                                <div class="property-info pt-2">
                                    <p class="property-info-text">1+1</p>
                                    <i class="fa fa-bed property-info-icon"></i>
                                    <p class="property-info-text">1</p>
                                    <i class="fa fa-bath property-info-icon"></i>
                                    <p class="property-info-text">670 sqft - 880 sqft</p>
                                    <p class="property-info-text">RM 58 psf</p>
                                </div>
        ...
        <footer class="mt-3">
            <div class="row">
              <div class="col-12 text-left" >
                <a href="Johor Fourth House 3.php" class="go-back-button">Go back</a>
              </div>
            </div>
        </footer>

        <script src="Johor Fourth House 3B.js"></script>
