...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="Johor Second House 3B.css">
    ...
    <body>
        ...
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-6">
                    <img src="Johor Second House Plan View2.jpg" alt="Image Alt Text" class="house-plan-view">
                </div>
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12 form">
                            <form>
                                ...
                                <p class="right-text">Developer <br>
                                    <span class="text2">Mah Sing Group Bhd</span>
                                </p>
                                <hr class="line">
                                ...
                                <p class="left-text ps-2">Listing ID <br>
                                    <span class="text1">17836532</span>
                                </p>
                            ...
                            <form>
                                ...
                                <div class="unit-info-container">
                                    <div class="unit-info-left">
                                        <a class="black-button" href="Johor Second House 3.php">
                                            <p class="unit-info">Type A <br> 1105 sqft</p>
                                        </a>
                                        <a class="white-button mt-2" href="Johor Second House 3B.php">
                                            <p class="unit-info">Type B <br> 1315 sqft</p>
                                        </a>
                                    </div>
                                    <div class="unit-info-right">
                                        <p class="price-text">RM560,000</p>
                                ...
                                <div class="property-info pt-2">
                                    ...
                                    <p class="property-info-text">1105 sqft - 1315 sqft</p>
                                    <p class="property-info-text">RM 338 psf</p>
                                </div>
        ...
        <footer class="mt-3">
            <div class="row">
              <div class="col-12 text-left" >
                <a href="Johor Second House 3.php" class="go-back-button">Go back</a>
              </div>
            </div>
        </footer>

        <script src="Johor Second House 3B.js"></script>
        <script>
            function buyHouse() {
