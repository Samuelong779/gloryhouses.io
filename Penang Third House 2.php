...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Penang Third House 2.css">
            ...
            <div class="col-md-6">
                <form>
                    <div class="form-group d-flex align-items-center">
                        <div>
                            <h2 class="form-title">RM900,000</h2>
                            <h5 class="additional-text">Est. Repayment RM 3,750 / month</h5>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">2 bed</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">1,033 sqft</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">RM 368 psf</span>
                            </div>
                        </div>
                    </div>
                    <img src="Penang House 7.jpg" alt="House Image" class="house-image" id="houseImage">
                </form>
            </div>
            <div class="col-md-6">
                <form>
                    <div class="form-group">
                        ...
                        <h2 class="form-title2 pt-2">Kavitha Parugah</h2>                  
                ...
                <form>
                    <div class="form-group">
                        ...
                        <p class="additional-text3">
                            Mezzo is the centrepiece of The Light City, the most recent<br>
                            phase of The Light Waterfront Penang. A retail mall, hotels, <br>
                            an office tower, luxurious highrise residences, and a convention <br>
                            centre are among the commercial and residential components <br>
                            of The Light City.<br><br>
                            Features: <br>
                            SMART LOCKERS, MEZZO COMMUNITY APP, PLUG-IN HYBRID and SECURITY SYSTEMS
                        </p>
                        <a href="Penang Third House 3.php" class="view-more">View more...</a>
                    </div>
                    <div class="form-group text-right location-container">
                        ...
                        <br>
                        <span class="location">Gelugor, Penang</span>
                        <a href="PenangThirdHouseMap.php" class="view-on-map">View on Map</a>
                    </div>
                </form>
            </div>
            <div class="col-md-12 d-flex justify-content-center align-items-center">
                <form>
                    <div class="form-group">
                        ...
                        <span class="albert-text ms-2">Muthu</span>
                        ...
                        <div class="rating-container ms-3">
                            ...
                            <span class="review-text">House was safe to be stay.</span> 
                        </div> 
                    </div>
                </form>
            </div>
    ...
    <footer class="mt-3">
        <div class="row">
          <div class="col-12 text-left" >
            <a href="Penang Third House.php" class="go-back-button">Go back</a>
          </div>
        </div>
    </footer>

    <script src="Penang Third House 2.js"></script>
</body>
</html>