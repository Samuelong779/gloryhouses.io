...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Malacca House 2.css">
            ...
            <div class="col-md-6">
                <form>
                    <div class="form-group d-flex align-items-center">
                        <div>
                            <h2 class="form-title">RM270,000</h2>
                            <h5 class="additional-text">Est. Repayment RM 1,125 / month</h5>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">3 bed</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">2 bath</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">865 sqft</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">RM 78 psf</span>
                            </div>
                        </div>
                    </div>
                    <img src="Malacca House.jpg" alt="House Image" class="house-image" id="houseImage">
                </form>
            </div>
            <div class="col-md-6">
                <form>
                    <div class="form-group">
                        ...
                        <h2 class="form-title2 pt-2">Jerry Koh</h2>                  
                ...
                <form>
                    <div class="form-group">
                        ...
                        <p class="additional-text3">
                            Affordable home with spacious layout, located in a <br>
                            strategic address of Melaka. Gated community to <br>
                            ensure your safety while being surrounded by <br>
                            Bukit Serindit. <br><br>
                            Special package and attractive price for all. <br>
                            Get the exclusive information while visiting <br>
                            the show unit. <br><br>
                            <b><u>EDUCATIONAL INSTITUTIONS</u></b>
                            <li class="dot">0.7 km SMK Seri Kota</li>
                            <li class="dot">0.9 km SMJK Yok Bin</li>
                            <li class="dot">1.6 km SM Seri Bandar</li>
                            <li class="dot">2.3 km SM Teknik Melaka</li><br>
                            <b class="dot2"><u>LEISURE & CONVENIENCES</u></b>
                            <li class="dot">2.2 km Elements Mall</li>
                            <li class="dot">2.3 km Jonker Street</li>
                            <li class="dot">3.8 km Mahkota Parade Shopping Mall</li><br>
                            <b class="dot2"><u>MEDICAL INSTITUTIONS</u></b>
                            <li class="dot">2.5 km Putra Specialist Hospital</li>
                            <li class="dot">2.7 km Melaka General Hospital</li>
                            <li class="dot">4.2 km Mahkota Medical Centre</li>
                        </p>
                        <a href="Malacca House 3.php" class="view-more">View more...</a>
                    </div>
                    <div class="form-group text-right location-container">
                        ...
                        <br>
                        <span class="location">Bukit Serindit, Malacca</span>
                        <a href="MalaccaFirstHouseMap.php" class="view-on-map">View on Map</a>
                    </div>
                </form>
            </div>
            <div class="col-md-12 d-flex justify-content-center align-items-center">
                <form>
                    <div class="form-group">
                        ...
                        <span class="albert-text ms-2">Darren</span>
                        ...
                        <div class="rating-container ms-3">
                            ...
                            <span class="rating-date">15 Sepetember 2023</span><br>
                            <span class="review-text">Got a fresh air when staying here.</span> 
                        </div> 
                    </div>
                </form>
            </div>
    ...
    <footer class="mt-3">
        <div class="row">
          <div class="col-12 text-left" >
            <a href="Malacca House.php" class="go-back-button">Go back</a>
          </div>
        </div>
    </footer>

    <script src="Malacca House 2.js"></script>
</body>
</html>