...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="Penang House 3B.css">
    ...
    <body>
        ...
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-6">
                    <img src="Penang House Plan View2.jpg" alt="Image Alt Text" class="house-plan-view">
                </div>
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12 form">
                            <form>
                                ...
                                <p class="left-text ps-2">Property Type <br>
                                    <span class="text1">High-rise Condominium</span>
                                </p>
                                <p class="right-text">Developer <br>
                                    <span class="text2">Mah Sing Group Berhad</span>
                                </p>
                                <hr class="line">
                                ...
                                <p class="left-text ps-2">Listing ID <br>
                                    <span class="text1">17446539</span>
                                </p>
                            ...
                            <form>
                                ...
                                <div class="unit-info-container">
                                    <div class="unit-info-left">
                                        <a class="black-button" href="Penang House 3.php">
                                            <p class="unit-info">Type A <br> 1208 sqft</p>
                                        </a>
                                        <a class="white-button mt-2" href="Penang House 3B.php">
                                            <p class="unit-info">Type B <br> 1494 sqft</p>
                                        </a>
                                    </div>
                                    <div class="unit-info-right">
                                        <p class="price-text">RM880,000</p>
                                ...
                                <div class="property-info pt-2">
                                    ...
                                    <p class="property-info-text">1208 sqft - 1494 sqft</p>
                                    <p class="property-info-text">RM 370 psf</p>
                                </div>
        ...
        <footer class="mt-3">
            <div class="row">
              <div class="col-12 text-left" >
                <a href="Penang House 3.php" class="go-back-button">Go back</a>
              </div>
            </div>
        </footer>

        <script src="Penang House 3B.js"></script>
        <script>
            function buyHouse() {
