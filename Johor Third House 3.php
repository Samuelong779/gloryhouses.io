...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="Johor Third House 3.css">
    ...
    <body>
        ...
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-6">
                    <img src="Johor Third House Plan View.png" alt="Image Alt Text" class="house-plan-view">
                </div>
                <div class="col-md-6">
                    <div class="row">
                            ...
                            <form>
                                ...
                                <div class="unit-info-container">
                                    ...
                                    <div class="unit-info-right">
                                        <p class="price-text">RM480,000</p>
        ...
        <footer class="mt-3">
            <div class="row">
              <div class="col-12 text-left" >
                <a href="Johor Third House 2.php" class="go-back-button">Go back</a>
              </div>
            </div>
        </footer>

        <script src="Johor Third House 3.js"></script>
        <script>
            function buyHouse() {
