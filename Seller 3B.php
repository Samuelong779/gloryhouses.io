...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="Seller 3B.css">
    ...
    <body>
        ...
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-6">
                    <img src="house plan view 2.jpg" alt="Image Alt Text" class="house-plan-view">
                </div>
                <div class="col-md-6">
                    <div class="row">
        ...
        <footer class="mt-3">
            <div class="row">
              <div class="col-12 text-left" >
                <a href="Seller 3.php" class="go-back-button">Go back</a>
              </div>
            </div>
        </footer>

        <script src="Seller 3B.js"></script>
