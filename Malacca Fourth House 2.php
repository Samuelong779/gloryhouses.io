...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Malacca Fourth House 2.css">
            ...
            <div class="col-md-6">
                <form>
                    <div class="form-group d-flex align-items-center">
                        <div>
                            <h2 class="form-title">RM948,000</h2>
                            <h5 class="additional-text">Est. Repayment RM 3,950 / month</h5>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">6 bed</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">7 bath</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">5,200 sqft</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">RM 1,888 psf</span>
                            </div>
                        </div>
                    </div>
                    <img src="Malacca Fourth House.jpg" alt="House Image" class="house-image" id="houseImage">
                </form>
            </div>
            <div class="col-md-6">
                <form>
                    <div class="form-group">
                        ...
                        <h2 class="form-title2 pt-2">Jeremmy Lau</h2>                  
                ...
                <form>
                    <div class="form-group">
                        ...
                        <p class="additional-text3">
                           <b><u>Premium Eco Lifestyle</u></b><br>
                           Green and secured living are the main focus of Taman Nuri Phase 3, the luxury <br>
                           residential enclave located in the heart of Durian Tunggal, Melaka. A guarded <br>
                           community offers serenity in everyday living, while the seamless integration <br>
                           of green spaces makes Taman Nuri Phase 3 a highly desirable development <br>
                           which is built in sync with its environment.<br><br>
                           <b><u>Additional Feature</u></b><br>
                           24-hr Security, Clubhouse, Playground, 3-phase Wiring, 
                           Jogging Lane, Private Yard, Access Card and Lake View.
                        </p>
                        <a href="Malacca Fourth House 3.php" class="view-more">View more...</a>
                    </div>
                    <div class="form-group text-right location-container">
                        ...
                        <br>
                        <span class="location">Bandar Melaka, Malacca</span>
                        <a href="MalaccaFourthHouseMap.php" class="view-on-map">View on Map</a>
                    </div>
                </form>
            </div>
            <div class="col-md-12 d-flex justify-content-center align-items-center">
                <form>
                    <div class="form-group">
                        ...
                        <span class="albert-text ms-2">Jim</span>
                        ...
                        <div class="rating-container ms-3">
                            ...
                            <span class="rating-date">15 November 2023</span><br>
                            <span class="review-text">All features are got inside this house.</span> 
                        </div> 
                    </div>
                </form>
            </div>
    ...
    <footer class="mt-3">
        <div class="row">
          <div class="col-12 text-left" >
            <a href="Malacca Fourth House.php" class="go-back-button">Go back</a>
          </div>
        </div>
    </footer>

    <script src="Malacca Fourth House 2.js"></script>
</body>
</html>