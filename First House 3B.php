...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="First House 3B.css">
    ...
    <body>
        ...
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-6">
                    <img src="First House View Plan 2.jpg" alt="Image Alt Text" class="house-plan-view">
                </div>
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12 form">
                            <form>
                                ...
                                <p class="left-text ps-2">Property Type <br>
                                    <span class="text1">Serviced Apartment</span>
                                </p>
                                <p class="right-text">Developer <br>
                                    <span class="text2">Livista Sri Damansara Sdn Bhd</span>
                                </p>
                                <hr class="line">
                                ...
                                <p class="right-text completion-year-text">Completion Year <br>
                                    <span class="text2">2027</span>
                                </p>
                                <hr class="line">
                                <p class="left-text ps-2">Total Units <br>
                                    <span class="text1">700</span>
                                </p>
                                ...
                                <p class="left-text ps-2">Listing ID <br>
                                    <span class="text1">12778853</span>
                                </p>
                                <p class="right-text listed-on">Listed On <br>
                                    <span class="text2">3 weeks ago</span>
                                </p>
                                <hr class="line">
                            </form>
                        </div>
                        ...
                        <div class="col-md-12 form">
                            <form>
                                ...
                                <div class="unit-types">
                                    <p class="unit-type">3 Bedrooms (B1)</p>
                                    <p class="unit-type">3 Bedrooms (B2)</p>
                                </div>
                                <hr class="line1">

                                <div class="unit-info-container">
                                    <div class="unit-info-left">
                                        <a class="black-button" href="First House 3.php">
                                            <p class="unit-info">Type B1 <br> 1012 sqft</p>
                                        </a>
                                        <a class="white-button mt-2" href="FirstHouse3B.php">
                                            <p class="unit-info">Type B2 <br> 1035 sqft</p>
                                        </a>
                                    </div>
                                ...
                                <div class="property-info pt-2">
                                    ...
                                    <p class="property-info-text">2</p>
                                    <i class="fa fa-bath property-info-icon"></i>
                                    <p class="property-info-text">1012 sqft - 1035 sqft</p>
                                    <p class="property-info-text">RM 288 psf</p>
                                </div>
        ...
        <footer class="mt-3">
            <div class="row">
              <div class="col-12 text-left" >
                <a href="First House 3.php" class="go-back-button">Go back</a>
              </div>
            </div>
        </footer>

        <script src="FirstHouse3B.js"></script>
