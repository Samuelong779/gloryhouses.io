...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Malacca Second House 2.css">
            ...
            <div class="col-md-6">
                <form>
                    <div class="form-group d-flex align-items-center">
                        <div>
                            <h2 class="form-title">RM570,000</h2>
                            <h5 class="additional-text">Est. Repayment RM 2,375 / month</h5>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">3 bath</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">1,126 sqft</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">RM 588 psf</span>
                            </div>
                        </div>
                    </div>
                    <img src="Malacca House 4.jpg" alt="House Image" class="house-image" id="houseImage">
                </form>
            </div>
            <div class="col-md-6">
                <form>
                        ...
                        <div class="review-section">
                            <div class="rating">
                                ...
                                <div class="stars">
                                    ...
                                    <span class="star" id="star-4"><i class="fas fa-star"></i></span>
                                    <span class="star" id="star-5"><i class="fas fa-star"></i></span>
                                </div>
                            </div>
                        </div>
                        <h2 class="form-title2 pt-2">Andre Khung</h2>                  
                ...
                <form>
                    <div class="form-group">
                        ...
                        <p class="additional-text3">
                            Living in Taman Sutera Wangi will enable you to live a life full of ease with the abundance of access and amenities that is scattered around your home! <br>
                            Your home is 3km away from the Sungai Udang-Paya Rumput-Ayer Keroh Highway (SPA) leading you to various key destinations such as Sungai Udang,Ayer Keroh and Melaka City. The PLUS highway is also strategically located near your home acting as the backbone of the West Coast which can take you anywhere and everywhere!
                            <li class="dot">3km away from the Sungai Udang-Paya Rumput-Ayer Keroh Highway (SPA)</li>
                            <li class="dot">Directly connected to the PLUS highway</li><br>
                            <b><p class="dot2">Medical Centre :</p></b>
                            <li class="dot">Polyclinic and Medical Centre Batu Berendam (3km)</li>
                            <li class="dot">Pantai Hospital (2km)</li>
                            <li class="dot">Hospital Melaka (8km)</li><br>
                            <b><p class="dot2">Institutional Education :</p></b>
                            <li class="dot">Multimedia University (5km)</li>
                            <li class="dot">SMK Batu Berendam (2km)</li>
                            <li class="dot">Sekolah Menengah Munshi Abdullah, Batu Berendam (2km)</li>
                            <li class="dot">Sekolah Rendah Kebangsaaan Batu Berendam (2km)</li><br>
                            <b><p class="dot2">Shopping Mall & Hypermarket :</p></b>
                            <li class="dot">AEONBukit Baru (4km)</li>
                            <li class="dot">Tesco Melaka (8km)</li>
                            <li class="dot">Giant Batu Berendam (6km)</li>
                        </p>
                        <a href="Malacca Second House 3.php" class="view-more">View more...</a>
                    </div>
                    <div class="form-group text-right location-container">
                        ...
                        <br>
                        <span class="location">Batu Berendam, Malacca</span>
                        <a href="MalaccaSecondHouseMap.php" class="view-on-map">View on Map</a>
                    </div>
                </form>
            </div>
            <div class="col-md-12 d-flex justify-content-center align-items-center">
                <form>
                    <div class="form-group">
                        ...
                        <span class="albert-text ms-2">Navine</span>
                        ...
                        <div class="rating-container ms-3">
                            ...
                            <span class="rating-date">10 November 2023</span><br>
                            <span class="review-text">House was BIG and nice to be stay.</span> 
                        </div> 
                    </div>
                </form>
            </div>
    ...
    <footer class="mt-3">
        <div class="row">
          <div class="col-12 text-left" >
            <a href="Malacca Second House.php" class="go-back-button">Go back</a>
          </div>
        </div>
    </footer>

    <script src="Malacca Second House 2.js"></script>
</body>
</html>