...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="JohorFourthHouse.css">
    ...
    <body>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="d-flex justify-content-center align-items-center image-container" style="height: 300px;">
                            <img src="JohorFourthHouse.png" class="d-block mx-auto img-fluid" alt="Image 1">
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="d-flex justify-content-center align-items-center image-container" style="height: 300px;">
                            <img src="JohorFourthHouse2.png" class="d-block mx-auto img-fluid" alt="Image 2">
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="d-flex justify-content-center align-items-center image-container" style="height: 300px;">
                            <img src="JohorFourthHouse3.png" class="d-block mx-auto img-fluid" alt="Image 3">
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="d-flex justify-content-center align-items-center image-container" style="height: 300px;">
                            <img src="JohorFourthHouse4.png" class="d-block mx-auto img-fluid" alt="Image 4">
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="container mt-3 my-3">
                <div class="row">
                    <div class="col-md-3">
                        <img src="JohorFourthHouse.png" alt="Image 1" class="img-thumbnail" data-bs-toggle="modal" data-bs-target="#imageModal1">
                    </div>
            
                    <div class="col-md-3">
                        <img src="JohorFourthHouse2.png" alt="Image 2" class="img-thumbnail" data-bs-toggle="modal" data-bs-target="#imageModal2">
                    </div>
            
                    <div class="col-md-3">
                        <img src="JohorFourthHouse3.png" alt="Image 3" class="img-thumbnail" data-bs-toggle="modal" data-bs-target="#imageModal3">
                    </div>

                    <div class="col-md-3">
                        <img src="JohorFourthHouse4.png" alt="Image 4" class="img-thumbnail" data-bs-toggle="modal" data-bs-target="#imageModal4">
                    </div>
                </div>
            </div>            
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        <img src="JohorFourthHouse.png" alt="Image 1" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="imageModal2" tabindex="-1" aria-labelledby="imageModalLabel2" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        <img src="JohorFourthHouse2.png" alt="Image 2" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="imageModal3" tabindex="-1" aria-labelledby="imageModalLabel3" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        <img src="JohorFourthHouse3.png" alt="Image 3" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="imageModal4" tabindex="-1" aria-labelledby="imageModalLabel3" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        <img src="JohorFourthHouse4.png" alt="Image 4" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
