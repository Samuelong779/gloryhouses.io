...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Second House.css">
    ...
    <div class="container pt-2">
        <div class="row">
            <div class="col-6 d-flex align-items-center justify-content-end">
                <img src="Second House.jpg" alt="Left Image" class="left-image" id="leftImage">
            </div>
            <div class="col-6">
                <div class="row">
                    <div class="col-12 py-2 d-flex align-items-center justify-content-center">
                        <img src="Second House 2.jpg" alt="Top Image" class="right-image" id="topImage">
                    </div>
                    <div class="col-12 pt-3 d-flex align-items-center justify-content-center">
                        <img src="Second House 3.jpg" alt="Bottom Image" class="right-image" id="bottomImage">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-6 d-flex justify-content-start">
                <span class="property-text">FREEHOLD 2 STOREY TERRACE - KEDIAMAN RESIDENCE PUCHONG</span>
            </div>
        ...
        <div class="row">
            <div class="col-12 d-flex text-start">
                <a href="Second House 2.php" class="view-details-link">View more Details</a>
            </div>
        </div>        
    </div>
    ...
    <footer class="mt-3">
        <div class="row">
          <div class="col-12 text-left" >
            <a href="Buyer.php" class="go-back-button">Go back</a>
          </div>
        </div>
    </footer>

    <script src="Second House.js"></script>
</body>
</html>