...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="Malacca Second House 3B.css">
    ...
    <body>
        ...
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-6">
                    <img src="Malacca Second House Plan View2.png" alt="Image Alt Text" class="house-plan-view">
                </div>
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12 form">
                            <form>
                                ...
                                <p class="left-text ps-2">Property Type <br>
                                    <span class="text1">2-Storey Semi-D & Single <br> Storey Bungalow</span>
                                </p>
                                <p class="right-text">Developer <br>
                                    <span class="text2">Syarikat Perumahan Negara <br> Berhad (SPNB) Sdn Bhd</span>
                                </p>
                                <hr class="line">
                                <p class="left-text ps-2">Tenure <br>
                                    <span class="text1">Leasehold (99 years)</span>
                                </p>
                                ...
                                <p class="left-text ps-2">Listing ID <br>
                                    <span class="text1">13374562</span>
                                </p>
                                <p class="right-text listed-on">Listed On <br>
                                    <span class="text2">5 weeks ago</span>
                                </p>
                                <hr class="line">
                            </form>
                        </div>
                        ...
                        <div class="col-md-12 form">
                            <form>
                                ...
                                <div class="unit-types">
                                    <p class="unit-type">4 Bedrooms (A)</p>
                                    <p class="unit-type">4 Bedrooms (B)</p>
                                </div>
                                <hr class="line1">

                                <div class="unit-info-container">
                                    <div class="unit-info-left">
                                        <a class="black-button" href="Malacca Second House 3.php">
                                            <p class="unit-info">Type A <br> 1126 sqft</p>
                                        </a>
                                        <a class="white-button mt-2" href="Malacca Second House 3B.php">
                                            <p class="unit-info">Type B <br> 1942 sqft</p>
                                        </a>
                                    </div>
                                    <div class="unit-info-right">
                                        <p class="price-text">RM770,000</p>
                                        <a class="starting-from-button" href="#">Starting From</a>
                                    </div>
                                </div>
                                <div class="property-info pt-2">
                                    <p class="property-info-text">4</p>
                                    <i class="fa fa-bed property-info-icon"></i>
                                    <p class="property-info-text">3</p>
                                    <i class="fa fa-bath property-info-icon"></i>
                                    <p class="property-info-text">1126 sqft - 1942 sqft</p>
                                    <p class="property-info-text">RM 588 psf</p>
                                </div>
        ...
        <footer class="mt-3">
            <div class="row">
              <div class="col-12 text-left" >
                <a href="Malacca Second House 3.php" class="go-back-button">Go back</a>
              </div>
            </div>
        </footer>

        <script src="Malacca Second House 3B.js"></script>
        <script>
            function buyHouse() {
