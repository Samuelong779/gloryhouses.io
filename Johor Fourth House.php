...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Johor Fourth House.css">
    ...
    <div class="container pt-2">
        <div class="row">
            <div class="col-6 d-flex align-items-center justify-content-end">
                <img src="Johor House 10.png" alt="Left Image" class="left-image" id="leftImage">
            </div>
            <div class="col-6">
                <div class="row">
                    <div class="col-12 py-2 d-flex align-items-center justify-content-center">
                        <img src="Johor House 11.png" alt="Top Image" class="right-image" id="topImage">
                    </div>
                    <div class="col-12 pt-3 d-flex align-items-center justify-content-center">
                        <img src="Johor House 12.png" alt="Bottom Image" class="right-image" id="bottomImage">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 d-flex justify-content-start">
                <div class="ellipse" style="background-color: #F50505;"></div>
                <span class="status-text">SALE - INACTIVE</span>
            </div>
        </div>
        <div class="row">
            <div class="col-6 d-flex justify-content-start">
                <span class="property-text">SERVICED APARTMENT FREEHOLD - M MINORI SALES GALLERY, JOHOR BAHRU, JOHOR</span>
            </div>
        ...
        <div class="row">
            <div class="col-12 d-flex text-start">
                <a href="Johor Fourth House 2.php" class="view-details-link">View more Details</a>
            </div>
        </div>        
    </div>
    ...
    <footer class="mt-3">
        <div class="row">
          <div class="col-12 text-left" >
            <a href="Buyer 2.php" class="go-back-button">Go back</a>
          </div>
        </div>
    </footer>

    <script src="Johor Fourth House.js"></script>
</body>
</html>