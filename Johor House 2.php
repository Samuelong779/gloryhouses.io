...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Johor House 2.css">
            ...
            <div class="col-md-6">
                <form>
                    <div class="form-group d-flex align-items-center">
                        <div>
                            <h2 class="form-title">RM780,000</h2>
                            <h5 class="additional-text">Est. Repayment RM 3,250 / month</h5>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">1,875 sqft</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">RM 375 psf</span>
                            </div>
                        </div>
                    </div>
                    <img src="Johor House.jpg" alt="House Image" class="house-image" id="houseImage">
                </form>
            </div>
            <div class="col-md-6">
                <form>
                    <div class="form-group">
                        ...
                        <h2 class="form-title2 pt-2">Loius Lim</h2>                  
                ...
                <form>
                    <div class="form-group">
                        ...
                        <p class="additional-text3">
                            School: 1km to SMK Bandar UDA Utama, 1.8km to SJKC Kuo Kang 2 and more. <br>
                            Shopping: 2.8km to Lotus Bukit Indah, 3.4km to Sutera Mall and more. <br>
                            Hospital: 5.1km to Columbia Asia Hospital, 13.1km to Sultanah Aminah Hospital and more. <br>
                            Bank: 2.1km to CIMB Taman Nusa Bestari, 3.4km to Public Bank Bukit Indah and more. <br>
                            Accessibility: 4.0km to Pasir Gudang Highway, 9.4km to Iskandar Coastal Highway and more. <br>
                            Facilities: Fully tiled car porch floor and Built in CCTV 
                        </p>
                        <a href="Johor House 3.php" class="view-more">View more...</a>
                    </div>
                    <div class="form-group text-right location-container">
                        ...
                        <br>
                        <span class="location">Mukim Pulai, Johor Bahru, Johor</span>
                        <a href="JohorFirstHouseMap.php" class="view-on-map">View on Map</a>
                    </div>
                </form>
            </div>
            <div class="col-md-12 d-flex justify-content-center align-items-center">
                <form>
                    <div class="form-group">
                        ...
                        <span class="albert-text ms-2">Thomas</span>
                        ...
                        <div class="rating-container ms-3">
                            ...
                            <span class="rating-date">3 August 2023</span><br>
                            <span class="review-text">Got a good environment.</span> 
                        </div> 
                    </div>
                </form>
            </div>
    ...
    <footer class="mt-3">
        <div class="row">
          <div class="col-12 text-left" >
            <a href="Johor House.php" class="go-back-button">Go back</a>
          </div>
        </div>
    </footer>

    <script src="Johor House 2.js"></script>
</body>
</html>