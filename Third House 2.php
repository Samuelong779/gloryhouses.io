...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Third House 2.css">
...
<body>
            ...
            <div class="col-md-6">
                <form>
                    <div class="form-group d-flex align-items-center">
                        <div>
                            <h2 class="form-title">RM750,000</h2>
                            <h5 class="additional-text">Est. Repayment RM 3,125 / month</h5>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">1,700 sqft</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">RM 208 psf</span>
                            </div>
                        </div>
                    </div>
                    <img src="Third House.png" alt="House Image" class="house-image" id="houseImage">
                </form>
            </div>
            <div class="col-md-6">
                <form>
                    <div class="form-group">
                        ...
                        <h2 class="form-title2 pt-2">Jeffrey Ng</h2>                  
                ...
                <form>
                    <div class="form-group">
                        ...
                        <p class="additional-text3">
                            Enjoy easy access to a well established network <br> of expressways
                            and public transportation to get <br> 
                            you to all the places that you love. <br><br>
                            <b>Excellent Connectivity via 4 Major Expressways</b><br>
                            • West Coast Expressway (WCE) <br>
                            • New Klang Valley Expressway (NKVE) <br>
                            • Shapadu Highway <br>
                            • Federal Highway <br>
                        </p>
                        <a href="Third House 3.php" class="view-more">View more...</a>
                    </div>
                    <div class="form-group text-right location-container">
                        ...
                        <br>
                        <span class="location">Bandar Bukit Raja, Klang, Selangor</span>
                        <a href="SelangorThirdHouseMap.php" class="view-on-map">View on Map</a>
                    </div>
                </form>
            </div>
            <div class="col-md-12 d-flex justify-content-center align-items-center">
                <form>
                    <div class="form-group">
                        ...
                        <span class="albert-text ms-2">Benjamin</span>
                        ...
                        <div class="rating-container ms-3">
                            ...
                            <span class="rating-date">31 October 2023</span><br>
                            <span class="review-text">Nice to stay.</span> 
                        </div> 
                    </div>
                </form>
            </div>
    ...
    <script src="Third House 2.js"></script>
</body>
</html>