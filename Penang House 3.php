...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="Penang House 3.css">
    ...
    <body>
        ...
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-6">
                    <img src="Penang House Plan View.jpg" alt="Image Alt Text" class="house-plan-view">
                </div>
                <div class="col-md-6">
                    <div class="row">
        ...
        <footer class="mt-3">
            <div class="row">
              <div class="col-12 text-left" >
                <a href="Penang House 2.php" class="go-back-button">Go back</a>
              </div>
            </div>
        </footer>

        <script src="Penang House 3.js"></script>
        <script>
            function buyHouse() {
