...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="transport2.css">
    ...
    <body class="body">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h1 class="title text-start pt-4">Here are the PJ863 Commercial Bandar Sri Damansara (Bus Stop) address: </h1>
                    <ul>
                        <li class="address text-start">Bandar Sri Damansara, 52200 Petaling Jaya, Selangor</li>
                    </ul>

                    <img src="transport2.png" alt="Image 1" class="img-thumbnail" data-bs-toggle="modal" data-bs-target="#imageModal1">
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        <img src="transport2.png" alt="Image 1" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
