...
<html>
    ...
    <body class="body">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h1 class="title text-start pt-4">Here are the Opposite Commercial Bandar Sri Damansara, Persiaran Perdana (Bus Stop) address: </h1>
                    <ul>
                        <li class="address text-start">Bandar Sri Damansara, 52200 Petaling Jaya, Selangor</li>
                    </ul>

                    <img src="transport.png" alt="Image 1" class="img-thumbnail" data-bs-toggle="modal" data-bs-target="#imageModal1">
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        <img src="transport.png" alt="Image 1" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
