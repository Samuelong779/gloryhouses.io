...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <h1 class="description pt-3">Welcome to Glory House Real Estate Website AI Chatbot: </h1>
                    <p class="text">Our AI Chatbot will help you to solve the questions that you want to be ask about the house information.</p>
                    <p class="text">
                        If you have any information need to ask about your dream house or your house, you can click the button below to ask our AI Chatbot:
                    </p>
                    <a href="ChatWithBot.php" class="btn btn-success btn-chatbot" target="_blank">Chat with Bot</a>
                    <p class="text pt-3">If you have faced any problem about our AI Chatbot, please contact us: </p>
                </div>
            </div>
        </div>
