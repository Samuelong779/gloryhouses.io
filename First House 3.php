...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="First House 3.css">
    ...
    <body>
        ...
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-6">
                    <img src="First House View Plan.jpg" alt="Image Alt Text" class="house-plan-view">
                </div>
                <div class="col-md-6">
                    <div class="row">
                            ...
                            <form>
                                ...
                                <div class="unit-info-container">
                                    <div class="unit-info-left">
                                        ...
                                        <a class="white-button mt-2" href="First House 3B.php">
                                            <p class="unit-info">Type B2 <br> 1035 sqft</p>
                                        </a>
                                    </div>
                                    <div class="unit-info-right">
                                        <p class="price-text">RM660,000</p>
        ...
        <footer class="mt-3">
            <div class="row">
              <div class="col-12 text-left" >
                <a href="First House 2.php" class="go-back-button">Go back</a>
              </div>
            </div>
        </footer>

        <script src="First House 3.js"></script>
