...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Johor Fourth House 2.css">
            ...
            <div class="col-md-6">
                <form>
                    <div class="form-group d-flex align-items-center">
                        <div>
                            <h2 class="form-title">RM288,000</h2>
                            <h5 class="additional-text">Est. Repayment RM 1,200 / month</h5>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">1+1 bed</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">1 bath</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">670 sqft</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">RM 58 psf</span>
                            </div>
                        </div>
                    </div>
                    <img src="Johor House 10.png" alt="House Image" class="house-image" id="houseImage">
                </form>
            </div>
            <div class="col-md-6">
                <form>
                    <div class="form-group">
                        ...
                        <h2 class="form-title2 pt-2">Kelvin Ng</h2>                  
                ...
                <form>
                    <div class="form-group">
                        ...
                        <p class="additional-text3">
                            Happiness starts with you. Opening the doors to M Minori leads <br>
                            you to the ideal life you dream of. Living in your dream homes <br>
                            in the heart of mature JB city, where everything is within reach <br>
                            provides unlimited connectivity and accessibility. M Minori <br>
                            offers limitless experience from a comprehensive selection of <br>
                            vibrant amenities and facilities, all in your safe space.
                        </p>
                        <a href="Johor Fourth House 3.php" class="view-more">View more...</a>
                    </div>
                    <div class="form-group text-right location-container">
                        ...
                        <br>
                        <span class="location">Johor Bahru, Johor</span>
                        <a href="JohorFourthHouseMap.php" class="view-on-map">View on Map</a>
                    </div>
                </form>
            </div>
            <div class="col-md-12 d-flex justify-content-center align-items-center">
                <form>
                    <div class="form-group">
                        ...
                        <span class="albert-text ms-2">Tom</span>
                        ...
                        <div class="rating-container ms-3">
                            ...
                            <span class="rating-date">15 September 2023</span><br>
                            <span class="review-text">Nice to be stay, got fresh air.</span> 
                        </div> 
                    </div>
                </form>
            </div>
    ...
    <footer class="mt-3">
        <div class="row">
          <div class="col-12 text-left" >
            <a href="Johor Fourth House.php" class="go-back-button">Go back</a>
          </div>
        </div>
    </footer>

    <script src="Johor Fourth House 2.js"></script>
</body>
</html>