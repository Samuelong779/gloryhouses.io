...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Penang Third House.css">
    ...
    <div class="container pt-2">
        <div class="row">
            <div class="col-6 d-flex align-items-center justify-content-end">
                <img src="Penang House 7.jpg" alt="Left Image" class="left-image" id="leftImage">
            </div>
            <div class="col-6">
                <div class="row">
                    <div class="col-12 py-2 d-flex align-items-center justify-content-center">
                        <img src="Penang House 8.jpg" alt="Top Image" class="right-image" id="topImage">
                    </div>
                    <div class="col-12 pt-3 d-flex align-items-center justify-content-center">
                        <img src="Penang House 9.jpg" alt="Bottom Image" class="right-image" id="bottomImage">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-6 d-flex justify-content-start">
                <span class="property-text">CONDOMINIUM FREEHOLD - MEZZO @ THE LIGHT CITY, GELUGOR, PENANG</span>
            </div>
        ...
        <div class="row">
            <div class="col-12 d-flex text-start">
                <a href="Penang Third House 2.php" class="view-details-link">View more Details</a>
            </div>
        </div>        
    </div>
    ...
    <footer class="mt-3">
        <div class="row">
          <div class="col-12 text-left" >
            <a href="Buyer 3.php" class="go-back-button">Go back</a>
          </div>
        </div>
    </footer>

    <script src="Penang Third House.js"></script>
</body>
</html>