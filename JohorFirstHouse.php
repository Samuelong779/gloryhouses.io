...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="JohorFirstHouse.css">
    ...
    <body>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="d-flex justify-content-center align-items-center image-container" style="height: 300px;">
                            <img src="JohorFirstHouse.jpg" class="d-block mx-auto img-fluid" alt="Image 1">
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="d-flex justify-content-center align-items-center image-container" style="height: 300px;">
                            <img src="JohorFirstHouse2.jpg" class="d-block mx-auto img-fluid" alt="Image 2">
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="d-flex justify-content-center align-items-center image-container" style="height: 300px;">
                            <img src="JohorFirstHouse3.jpg" class="d-block mx-auto img-fluid" alt="Image 3">
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="container mt-3 my-3">
                <div class="row">
                    <div class="col-md-3">
                        <img src="JohorFirstHouse.jpg" alt="Image 1" class="img-thumbnail" data-bs-toggle="modal" data-bs-target="#imageModal1">
                    </div>
            
                    <div class="col-md-3">
                        <img src="JohorFirstHouse2.jpg" alt="Image 2" class="img-thumbnail" data-bs-toggle="modal" data-bs-target="#imageModal2">
                    </div>
            
                    <div class="col-md-3">
                        <img src="JohorFirstHouse3.jpg" alt="Image 3" class="img-thumbnail" data-bs-toggle="modal" data-bs-target="#imageModal3">
                    </div>
                </div>
            </div>            
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        <img src="JohorFirstHouse.jpg" alt="Image 1" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="imageModal2" tabindex="-1" aria-labelledby="imageModalLabel2" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        <img src="JohorFirstHouse2.jpg" alt="Image 2" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="imageModal3" tabindex="-1" aria-labelledby="imageModalLabel3" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        <img src="JohorFirstHouse3.jpg" alt="Image 3" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
