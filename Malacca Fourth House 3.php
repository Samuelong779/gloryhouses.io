...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="Malacca Fourth House 3.css">
    ...
    <body>
        ...
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-6">
                    <img src="Malacca Fourth House Plan View.jpg" alt="Image Alt Text" class="house-plan-view">
                </div>
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12 form">
                            <form>
                                ...
                                <p class="left-text ps-2">Property Type <br>
                                    <span class="text1">Bungalow</span>
                                </p>
                                <p class="right-text">Developer <br>
                                    <span class="text2">Sri Pengkalan Binaan Sdn Bhd</span>
                                </p>
                                <hr class="line">
                                ...
                                <p class="left-text ps-2">Listing ID <br>
                                    <span class="text1">32453678</span>
                                </p>
                                ...
                                <div class="unit-info-container">
                                    <div class="unit-info-left">
                                        <a class="black-button" href="#">
                                            <p class="unit-info">Type A <br> 5200 sqft</p>
                                        </a>
                                    </div>
                                    <div class="unit-info-right">
                                        <p class="price-text">RM948,000</p>
                                        <a class="starting-from-button" href="#">Starting From</a>
                                    </div>
                                </div>
                                <div class="property-info pt-2">
                                    <p class="property-info-text">6</p>
                                    <i class="fa fa-bed property-info-icon"></i>
                                    <p class="property-info-text">7</p>
                                    <i class="fa fa-bath property-info-icon"></i>
                                    <p class="property-info-text">5200 sqft</p>
                                    <p class="property-info-text">RM 1888 psf</p>
                                </div>
        ...
        <footer class="mt-3">
            <div class="row">
              <div class="col-12 text-left" >
                <a href="Malacca Fourth House 2.php" class="go-back-button">Go back</a>
              </div>
            </div>
        </footer>

        <script src="Malacca Fourth House 3.js"></script>
        <script>
            function buyHouse() {
