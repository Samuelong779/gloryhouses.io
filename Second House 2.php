...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Second House 2.css">
            ...
            <div class="col-md-6">
                <form>
                    <div class="form-group d-flex align-items-center">
                        <div>
                            <h2 class="form-title">RM870,000</h2>
                            <h5 class="additional-text">Est. Repayment RM 2,190 / month</h5>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">2,020 sqft</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">RM 388 psf</span>
                            </div>
                        </div>
                    </div>
                    <img src="Second House.jpg" alt="House Image" class="house-image" id="houseImage">
                </form>
            </div>
            <div class="col-md-6">
                <form>
                    <div class="form-group">
                        ...
                        <h2 class="form-title2 pt-2">Selly Chen</h2>                  
                ...
                <form>
                    <div class="form-group">
                        ...
                        <p class="additional-text3">
                            • Easy access to LDP, ELITE Highway, SKVE Highway, MEX Highway <br>
                            • School - SJK (C) Han Ming Puchong, SMK Puchong Utama 1, MASA College <br>
                            • 10 minutes to Uptown Night Baazar Puchong Utama, AEON Big Puchong Utama <br>
                            • 20 minutes to Pusat Bandar Puchong, IOI Mall, IOI City Mall <br>
                            • 10 minutes from Cyberjaya <br>
                            • 20 minutes from Putrajaya
                        </p>
                        <a href="Second House 3.php" class="view-more">View more...</a>
                    </div>
                    <div class="form-group text-right location-container">
                        ...
                        <br>
                        <span class="location">Puchong, Selangor</span>
                        <a href="SelangorSecondHouseMap.php" class="view-on-map">View on Map</a>
                    </div>
                </form>
            </div>
            <div class="col-md-12 d-flex justify-content-center align-items-center">
                <form>
                    <div class="form-group">
                        ...
                        <span class="albert-text ms-2">Olivia</span>
                        ...
                        <div class="rating-container ms-3">
                            ...
                            <span class="review-text">Good to be Stay.</span> 
                        </div> 
                    </div>
                </form>
            </div>
    ...
    <footer class="mt-3">
        <div class="row">
          <div class="col-12 text-left" >
            <a href="Second House.php" class="go-back-button">Go back</a>
          </div>
        </div>
    </footer>

    <script src="Second House 2.js"></script>
</body>
</html>