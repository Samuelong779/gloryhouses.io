...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Malacca Third House 2.css">
            ...
            <div class="col-md-6">
                <form>
                    <div class="form-group d-flex align-items-center">
                        <div>
                            <h2 class="form-title">RM762,000</h2>
                            <h5 class="additional-text">Est. Repayment RM 3,175 / month</h5>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">5 bed</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">3,268 sqft</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="icon-container">
                                ...
                                <span class="icon-text">RM 888 psf</span>
                            </div>
                        </div>
                    </div>
                    <img src="Malacca House 7.jpg" alt="House Image" class="house-image" id="houseImage">
                </form>
            </div>
            <div class="col-md-6">
                <form>
                    <div class="form-group">
                        ...
                        <h2 class="form-title2 pt-2">Tony See</h2>                  
                ...
                <form>
                    <div class="form-group">
                        ...
                        <p class="additional-text3">
                           ...
                           Green and secured living are the main focus of Taman Nuri Phase 3, the <br>
                           luxury residential enclave located in the heart of Durian Tunggal, Melaka. <br>
                           A guarded community offers serenity in everyday living, while the seamless <br>
                           integration of green spaces makes Taman Nuri Phase 3 a highly desirable <br>
                           development which is built in sync with its environment.<br><br>
                        ...
                        <a href="Malacca Third House 3.php" class="view-more">View more...</a>
                    </div>
                    <div class="form-group text-right location-container">
                        ...
                        <a href="MalaccaThirdHouseMap.php" class="view-on-map">View on Map</a>
                    </div>
                </form>
            </div>
            <div class="col-md-12 d-flex justify-content-center align-items-center">
                <form>
                    <div class="form-group">
                        ...
                        <span class="albert-text ms-2">Jimmy</span>
                        ...
                        <div class="rating-container ms-3">
                            ...
                            <span class="rating-date">12 October 2023</span><br>
                            <span class="review-text">Security of the house was perfect.</span>
                        </div> 
                    </div>
                </form>
            </div>
    ...
    <footer class="mt-3">
        <div class="row">
          <div class="col-12 text-left" >
            <a href="Malacca Third House.php" class="go-back-button">Go back</a>
          </div>
        </div>
    </footer>

    <script src="Malacca Third House 2.js"></script>
</body>
</html>