...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="Penang Second House 3B.css">
    ...
    <body>
        ...
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-6">
                    <img src="Penang Second House Plan View2.jpg" alt="Image Alt Text" class="house-plan-view">
                </div>
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12 form">
                            <form>
                                ...
                                <p class="left-text ps-2">Property Type <br>
                                    <span class="text1">2-storey Terrace Homes</span>
                                </p>
                                <p class="right-text">Developer <br>
                                    <span class="text2">DNP Land Sdn Bhd</span>
                                </p>
                                <hr class="line">
                                <p class="left-text ps-2">Tenure <br>
                                    <span class="text1">Freehold</span>
                                </p>
                                <p class="right-text completion-year-text">Completion Year <br>
                                    <span class="text2">2024</span>
                                </p>
                                <hr class="line">
                                <p class="left-text ps-2">Total Units <br>
                                    <span class="text1">78</span>
                                </p>
                                ...
                                <p class="left-text ps-2">Listing ID <br>
                                    <span class="text1">13579886</span>
                                </p>
                                <p class="right-text listed-on">Listed On <br>
                                    <span class="text2">7 weeks ago</span>
                                </p>
                                <hr class="line">
                            </form>
                        </div>
                        ...
                        <div class="col-md-12 form">
                            <form>
                                ...
                                <div class="unit-types">
                                    ...
                                    <p class="unit-type">5 Bedrooms</p>
                                </div>
                                <hr class="line1">

                                <div class="unit-info-container">
                                    <div class="unit-info-left">
                                        <a class="black-button" href="Penang Second House 3.php">
                                            <p class="unit-info">Type B <br> 1900 sqft</p>
                                        </a>
                                        <a class="white-button mt-2" href="Penang Second House 3B.php">
                                            <p class="unit-info">Type C <br> 2230 sqft</p>
                                        </a>
                                    </div>
                                    <div class="unit-info-right">
                                        <p class="price-text">RM940,000</p>
                                ...
                                <div class="property-info pt-2">
                                    ...
                                    <p class="property-info-text">5</p>
                                    <i class="fa fa-bath property-info-icon"></i>
                                    <p class="property-info-text">1900 sqft - 2230 sqft</p>
                                    <p class="property-info-text">RM 538 psf</p>
                                </div>
        ...
        <footer class="mt-3">
            <div class="row">
              <div class="col-12 text-left" >
                <a href="Penang Second House 3.php" class="go-back-button">Go back</a>
              </div>
            </div>
        </footer>

        <script src="Penang Second House 3B.js"></script>
        <script>
            function buyHouse() {
