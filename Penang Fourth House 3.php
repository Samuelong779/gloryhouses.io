...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="Penang Fourth House 3.css">
    ...
    <body>
        ...
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-6">
                    <img src="Penang Fourth House Plan View.jpg" alt="Image Alt Text" class="house-plan-view">
                </div>
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12 form">
                            <form>
                                ...
                                <p class="left-text ps-2">Property Type <br>
                                    <span class="text1">Double Storey Superlink Homes</span>
                                </p>
                                <p class="right-text">Developer <br>
                                    <span class="text2">S P Setia Sdn Bhd</span>
                                </p>
                                <hr class="line">
                                ...
                                <p class="left-text ps-2">Listing ID <br>
                                    <span class="text1">37785422</span>
                                </p>
                        ...
                        <div class="col-md-12 form">
                            <form>
                                ...
                                <div class="unit-info-container">
                                    <div class="unit-info-left">
                                        <a class="black-button" href="#">
                                            <p class="unit-info">Type A <br> 2727 sqft</p>
                                        </a>
                                    </div>
                                    <div class="unit-info-right">
                                        <p class="price-text">RM700,800</p>
                                ...
                                <div class="property-info pt-2">
                                    ...
                                    <p class="property-info-text">2727 sqft</p>
                                    <p class="property-info-text">RM 688 psf</p>
                                </div>
        ...
        <footer class="mt-3">
            <div class="row">
              <div class="col-12 text-left" >
                <a href="Penang Fourth House 2.php" class="go-back-button">Go back</a>
              </div>
            </div>
        </footer>

        <script src="Penang Fourth House 3.js"></script>
        <script>
            function buyHouse() {
