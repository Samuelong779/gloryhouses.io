...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="Johor House 3B.css">
    ...
    <body>
        ...
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-6">
                    <img src="Johor House Plan View2.png" alt="Image Alt Text" class="house-plan-view">
                </div>
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12 form">
                            <form>
                                ...
                                <p class="left-text ps-2">Property Type <br>
                                    <span class="text1">Double Storey Terrace (Superlink)</span>
                                </p>
                                <p class="right-text">Developer <br>
                                    <span class="text2">UDA Property Sdn Bhd</span>
                                </p>
                                <hr class="line">
                                ...
                                <p class="left-text ps-2">Listing ID <br>
                                    <span class="text1">53466782</span>
                                </p>
                        ...
                        <div class="col-md-12 form">
                            <form>
                                ...
                                <div class="unit-types">
                                    ...
                                    <p class="unit-type">6 Bedrooms</p>
                                </div>
                                <hr class="line1">

                                <div class="unit-info-container">
                                    <div class="unit-info-left">
                                        <a class="black-button" href="Johor House 3.php">
                                            <p class="unit-info">Type A <br> 1875 sqft</p>
                                        </a>
                                        <a class="white-button mt-2" href="Johor House 3B.php">
                                            <p class="unit-info">Type B <br> 2236 sqft</p>
                                        </a>
                                    </div>
                                    <div class="unit-info-right">
                                        <p class="price-text">RM980,000</p>
                                ...
                                <div class="property-info pt-2">
                                    ...
                                    <p class="property-info-text">1875 sqft - 2236 sqft</p>
                                    <p class="property-info-text">RM 375 psf</p>
                                </div>
        ...
        <footer class="mt-3">
            <div class="row">
              <div class="col-12 text-left" >
                <a href="Johor House 3.php" class="go-back-button">Go back</a>
              </div>
            </div>
        </footer>

        <script src="Johor House 3B.js"></script>
        <script>
            function buyHouse() {
