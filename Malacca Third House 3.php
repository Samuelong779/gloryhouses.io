...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="Malacca Third House 3.css">
    ...
    <body>
        ...
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-6">
                    <img src="Malacca Third House Plan View.png" alt="Image Alt Text" class="house-plan-view">
                </div>
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12 form">
                            <form>
                                ...
                                <p class="left-text ps-2">Property Type <br>
                                    <span class="text1">Bungalow (ZERO LOT)</span>
                                </p>
                                ...
                                <p class="left-text ps-2">Listing ID <br>
                                    <span class="text1">23354468</span>
                                </p>
                        ...
                        <div class="col-md-12 form">
                            <form>
                                ...
                                <div class="unit-info-container">
                                    <div class="unit-info-left">
                                        <a class="black-button" href="#">
                                            <p class="unit-info">Type A <br> 3268 sqft</p>
                                        </a>
                                    </div>
                                    <div class="unit-info-right">
                                        <p class="price-text">RM762,000</p>
                                ...
                                <div class="property-info pt-2">
                                    ...
                                    <p class="property-info-text">3268 sqft</p>
                                    <p class="property-info-text">RM 888 psf</p>
                                </div>
        ...
        <footer class="mt-3">
            <div class="row">
              <div class="col-12 text-left" >
                <a href="Malacca Third House 2.php" class="go-back-button">Go back</a>
              </div>
            </div>
        </footer>

        <script src="Malacca Third House 3.js"></script>
        <script>
            function buyHouse() {
