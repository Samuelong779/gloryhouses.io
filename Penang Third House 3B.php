...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="Penang Third House 3B.css">
    ...
    <body>
        ...
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-6">
                    <img src="Penang Third House Plan View2.jpg" alt="Image Alt Text" class="house-plan-view">
                </div>
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12 form">
                            <form>
                                ...
                                <p class="left-text ps-2">Property Type <br>
                                    <span class="text1">Condominium</span>
                                </p>
                                <p class="right-text">Developer <br>
                                    <span class="text2">The Light City Sdn Bhd</span>
                                </p>
                                <hr class="line">
                                ...
                                <p class="left-text ps-2">Listing ID <br>
                                    <span class="text1">18886543</span>
                                </p>
                                <p class="right-text listed-on">Listed On <br>
                                    <span class="text2">8 weeks ago</span>
                                </p>
                                <hr class="line">
                            </form>
                        </div>
                        ...
                        <div class="col-md-12 form">
                            <form>
                                ...
                                <div class="unit-types">
                                    <p class="unit-type">2 Bedrooms</p>
                                ...
                                <div class="unit-info-container">
                                    <div class="unit-info-left">
                                        <a class="black-button" href="Penang Third House 3.php">
                                            <p class="unit-info">Type A <br> 1033 sqft</p>
                                        </a>
                                        <a class="white-button mt-2" href="Penang Third House 3B.php">
                                            <p class="unit-info">Type B <br> 1292 sqft</p>
                                        </a>
                                    </div>
                                    <div class="unit-info-right">
                                        <p class="price-text">RM1000,000</p>
                                ...
                                <div class="property-info pt-2">
                                    ...
                                    <p class="property-info-text">1033 sqft - 1292 sqft</p>
                                    <p class="property-info-text">RM 368 psf</p>
                                </div>
        ...
        <footer class="mt-3">
            <div class="row">
              <div class="col-12 text-left" >
                <a href="Penang Third House 3.php" class="go-back-button">Go back</a>
              </div>
            </div>
        </footer>

        <script src="Penang Third House 3B.js"></script>
        <script>
            function markAsSold() {
